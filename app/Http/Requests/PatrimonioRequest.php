...
class PatrimonioRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'CodInterno' => 'required|string|size:10|unique:detallepatrimonio,CodInterno',
            'CodUTES' => 'nullable|string|max:12|unique:detallepatrimonio,CodUTES',
    ...
    public function messages()
    {
        return [
            ...
            'CodUTES.max' => 'El código UTES debe tener 12 caracteres.',
