        ...
        <div class="row g-2 justify-content-start">
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                <div class="form-group mb-2">
                    ...
                    <input type="text" id="codutes" name="codutes" class="form-control" value=""
            ...
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                <div class="form-group mb-2">
                    ...
                    <input type="text" id="codinterno" name="codinterno" class="form-control" value=""
                        placeholder="Código de máxmo 12 digitos.">
                </div>
            </div>
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                <div class="form-group mb-2">
            ...
            @if ($vista['articulo'])
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div class="form-group mb-2">
                        ...
                        <input type="text" id="tipo" name="tipo" class="form-control" value=""
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div class="form-group mb-2">
                        ...
                        <input type="text" id="marca" name="marca" class="form-control" value=""
                            placeholder="HP/Acer/Adesco/ADC">
                    </div>
                </div>
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div class="form-group mb-2">
                        <label for="modelo" class="form-label">Modelo:</label>
                        <input type="text" id="modelo" name="modelo" class="form-control" value=""
                            placeholder="1800px/Intel Core TM i5/HR digital">
                    </div>
                </div>
            @endif
            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="form-group mb-2">
                    ...
                    <input type="text" id="patrimonio" name="patrimonio" class="form-control" value=""
            ...
            @if ($vista['comentario'])
                <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12">
                    <div class="form-group mb-2">
                        ...
                        <textarea type="text" id="comentario" name="comentario" class="form-control" style="resize: none;" value=""
            ...
            <div
                ...
                <div class="d-grid gap-2">
                    <button type="button" class="btn btn-primary btn-block" onclick="{{ $vista['scriptBoton'] }}">{{ $vista['boton'] }}</button>
                </div>
            </div>
        </div>
    </div>
